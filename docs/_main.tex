...
\section{Installing supported sensors}\label{installing-supported-sensors}

The \texttt{sc-inst} command can be used to install support for a sensor. The command takes the name of the sensor as an argument, and will install the necessary scripts and packages to support the sensor.

\begin{Shaded}
\begin{Highlighting}[]
\ExtensionTok{sc{-}inst} \OperatorTok{\textless{}}\NormalTok{sensor{-}name}\OperatorTok{\textgreater{}}
\end{Highlighting}
\end{Shaded}
