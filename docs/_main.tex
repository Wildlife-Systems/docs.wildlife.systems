...
\ExtensionTok{ws{-}heartbeat}\NormalTok{ countdown 5   }\CommentTok{\# counts down from 5}
\ExtensionTok{ws{-}heartbeat}\NormalTok{ record action }\CommentTok{\# record light is on while action is executed}
\end{Highlighting}
\end{Shaded}
