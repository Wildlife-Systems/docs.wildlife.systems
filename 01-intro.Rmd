...
```{r, storage-costs, echo=FALSE, cache=TRUE, fig.cap="The decline in storage costs per megabyte in consumer hard drives.", fig.alt="Line chart showing the exponential decline in hard drive storage costs from 1980 to present, demonstrating how data storage has become increasingly affordable over time."}
library(figuREd)
storageCosts()
``` 
