# Sensors in WildlifeSystems {#sensors-in-wildlifesystems}
...
The bash function `sc-prototype` is used by sensor scripts to obtain a template JSON string that can be populated with sensor readings.
